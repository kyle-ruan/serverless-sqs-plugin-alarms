...
const DEFAULT_METRIC_NAME = 'ApproximateNumberOfMessagesVisible';
      ...
      (props, i) => {
        ...
        const config = {
          [this.formatAlarmName(properties.value)]: {
            ...
            Properties: {
              AlarmDescription: this.description || util.format('Alarm if queue contains more than %s messages', properties.value),
              Namespace: properties.namespace || 'AWS/SQS',
              MetricName: this.metricName || DEFAULT_METRIC_NAME,
              Dimensions: [
                {
                  Name: 'QueueName',
                  Value: this.queue
